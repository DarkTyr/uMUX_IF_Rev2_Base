...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LoopBack_En_Pin Synth_Enable_Pin */
  GPIO_InitStruct.Pin = LoopBack_En_Pin|Synth_Enable_Pin;
  ...
  HAL_GPIO_Init(SPI1_nINT_GPIO_Port, &GPIO_InitStruct);
